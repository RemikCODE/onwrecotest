...
from hwr.constants import pick_line_strokes_root, pick_line_mlf
...
class IAMReader(object):
    ...
    def __init__(self, split, data_path=PATH.DATA_DIR):
        ...
        self.line_data_path = pick_line_strokes_root(data_path)
        self.mlf_path = pick_line_mlf(data_path)
        self.split = split
        self.samples = None

    def get_line_data_path(self):
        return self.line_data_path
